...
with open(r'/workspaces/TC_Financas/modelos/LSTM_treinado_modelo_1.pkl', 'rb') as file:
    
    model = pickle.load(file)

with open(r'/workspaces/TC_Financas/modelos/LSTM_scaler.pkl', 'rb') as scaler_file:
